      ...
      <Card className='card-art'>
        ...
        <CardBody className='all-art-body'>
          ...
          >
            ...
            <button className={but} type='submit' onClick={this.DeSale}>
              DeSell Item
            </button>
            <button
              className='abtn'
            ...
            >
              ...
              <Card className='artCard'>
                <CardImg top src={this.props.art.imgurl} alt='Card image' />
                <CardBody>
            ...
            <Modal
              ...
              className='modal_popup'
            >
              <ModalHeader toggle={this.toggleAuction} className='pl-5'>
                Start Auction
              </ModalHeader>
